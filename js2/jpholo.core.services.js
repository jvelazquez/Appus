...
function initServiceSettings() {
	...
	$('#serviceRunOnce').off("click").on("click",
		function () {
			// You could also use the option setConfig here. In the Java code you will have to handle the preferences then. But because of the plugin AndroidPreferences in Universidad del Sur, we will use that.
